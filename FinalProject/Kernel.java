            ...
            case INTERRUPT_SOFTWARE: // System calls
                switch (cmd) {
                    ...
                    case RAWREAD: // read a block of data from disk
                        ...
                        // it's possible that a thread waiting to make a request was released by the
                        // disk, but then promptly looped back, found the buffer wasn't available for
                        // sending (bufferReady == true) and then went back to sleep
                    ...
                    case READ:
                        ...
                        // get TCB and File Table Entry
                        // then call the fs read method
                        if ((myTcb = scheduler.getMyTcb()) != null) {
                    ...
                    case WRITE:
                        ...
                        // get TCB and get the file table entry
                        // then call the fs write method
                        if ((myTcb = scheduler.getMyTcb()) != null) {
                            FileTableEntry entry = myTcb.getFtEnt(param);
                            if (entry != null)
                    ...
                    case OPEN: // to be implemented in project
                        // get the TCB and then open the file via
                        // fs and return the file descriptor
                        if ((myTcb = scheduler.getMyTcb()) != null) {
                    ...
                    case CLOSE: // to be implemented in project
                        // get the TCB and then close the file
                        if ((myTcb = scheduler.getMyTcb()) != null) {
                    ...
                    case SIZE: // to be implemented in project
                        // get the tcb and then get the file size via fs
                        if ((myTcb = scheduler.getMyTcb()) != null) {
                            FileTableEntry ftEnt = myTcb.getFtEnt(param);
                    ...
                    case SEEK: // to be implemented in project
                        // get the tcb and use that to get the file
                        // table entry and call fs seek
                        if ((myTcb = scheduler.getMyTcb()) != null) {
                    ...
                    case FORMAT: // to be implemented in project
                        // call the fs format and return the status
                        return (fs.format(param) == true) ? OK : ERROR;

                    case DELETE: // to be implemented in project
                        // delete a file by calling fs delete method
